  ...
  const columns: Array<any> = [
    {
      ...
      render: (name: any, item: any) => {
        return <EuiLink onClick={() => viewIndex(item)}>{name}</EuiLink>;
      },
    },
    {
      field: "health",
      ...
      render: (health: any) => {
        return (
          <EuiHealth textSize="s" color={health ? "success" : "danger"}>
            {health ? "Healthy" : "Errors"}
          </EuiHealth>
        );
      },
    },
    ...
    },
    {
      ...
      render: (status: any) => {
        return (
          <EuiBadge color={status ? "success" : "danger"}>
